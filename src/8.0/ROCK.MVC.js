(function() {
	...
	ROCK.MVC = {
		Model: ROCK.EventDispatcher.extend({
		...
		View: ROCK.EventDispatcher.extend({
		...
		Controller: ROCK.EventDispatcher.extend({
			constructor: function Controller() {

			}
		}),
		Router: ROCK.EventDispatcher.extend({
		...
		Collection: ROCK.EventDispatcher.extend({
